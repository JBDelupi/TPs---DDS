...
VALUES
    (1, 'Fisico', NULL, 'jdelupi@frba.utn.edu.ar', md5('1'), 'jdelupi@frba.utn.edu.ar', NULL, NULL, NULL, 'Correo', 'jdelupi@frba.utn.edu.ar', NULL, 'FISICO', true),
    (2, 'Juridico', 'Ayacucho ', 'AppleOficial@apple.com', md5('Appleoficial1.'), 'AppleOficial@apple.com', NULL, 'recoleta', NULL, 'Correo', 'Apple', '1184', 'JURIDICO', true);
